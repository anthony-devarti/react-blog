            ...
            {posts.map(post => {
              return (
                ...
                <div className="col col">
                    <div className="card card-cover h-100 overflow-hidden text-white bg-dark rounded-5 shadow-lg card scrollable" style={{maxWidth:'80vw', maxHeight:"400px", alignitems:'center'}} key={post.id}>
